...
Android Google Play: https://play.google.com/store/apps/details?id=com.avlasov.apexdeco
...
// Both engines return an object like:
// { plan, stops, totalRuntime, totalOTU, totalCNS, ... }
// When calling them directly, pass only active levels / deco gases;
// the UI-only `selected` flag is not required.
```
